...
const tablesSchema = __schema({
  missile: __table({
    ...
    constraints: [
      { name: 'missile_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, MissileRow),
  player: __table({
    name: 'player',
...
const reducersSchema = __reducers(
  __reducerSchema("fire_missile", FireMissileReducer),
  __reducerSchema("register_player", RegisterPlayerReducer),
  __reducerSchema("set_waypoint", SetWaypointReducer),
  __reducerSchema("spawn_ship", SpawnShipReducer),
  __reducerSchema("toggle_radar", ToggleRadarReducer),
);
